...
# Legacy Gemini import (commented out)
...
from llm import call_llm_with_retry, parse_llm_json, extract_pdf_text
...
def run_web_pipeline(
    ...
    # Extract text from PDF (instead of Gemini's native PDF upload)
    pdf_text = extract_pdf_text(pdf_bytes)

    # Legacy Gemini PDF handling (commented out)
